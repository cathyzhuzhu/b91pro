...
//    }
    ...
    private void initialShardedPool()
    {
      ...
      shards.add(new JedisShardInfo("172.16.0.249", 6379, "slave"));
//        shards.add(new JedisShardInfo(masterHost, masterPort, masterName));
//        shards.add(new JedisShardInfo(slaveHost, slavePort, slaveName));
     ...
     * @param value value值
     */
    public void  setKeyValue(String key,String value,int second){
        initialShardedPool();
        shardedJedis = shardedJedisPool.getResource();
...
//        System.out.println("清空库中所有数据："+jedis.flushDB());
    ...
    public static void main(String[] args) {
        ...
        new RedisClient().setKeyValue("aa","123",60);
//        System.out.println(new RedisClient().getKeyExists("aa"));
    }
}
